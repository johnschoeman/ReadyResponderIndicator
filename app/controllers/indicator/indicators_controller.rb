module Indicator
  class IndicatorsController < ApplicationController
    ...
    # GET /alert/leds
    def index
      @indicators = ::Indicator::Indicator.all
    end
    ...
    # GET /alert/leds/new
    def new
      redirect_to indicators_url, notice: 'You are not authorized to do that.'
    end
    ...
    # POST /alert/leds
    def create
      @indicator = ::Indicator::Indicator.new(indicator_params)

      if @indicator.save
        redirect_to indicator_path(@indicator), notice: 'Indicator was successfully created.'
      else
        render :new
      end
    end
    ...
    def update
      if @indicator.update(indicator_params)
        redirect_to indicator_path(@indicator), notice: 'Indicator was successfully updated.'
      else
        render :edit
      end
    end
